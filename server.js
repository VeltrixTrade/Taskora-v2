...
app.post("/api/packages/:id/buy", auth, async (req, res) => {
  ...
  try {
    ...
    const taskDetails = [
      ...
      { title: "📢 مشاركة رابط الدعوة على الواتساب (المجموعة الأولى)", desc: "قم بمشاركة رسالة دعوتنا ورابط موقعنا مع شخصين (2) مختلفين على تطبيق الواتساب لدعوتهم للتسجيل والاستثمار." },
      ...
      { title: "📢 مشاركة رابط الدعوة على الواتساب (المجموعة الثانية)", desc: "قم بمشاركة رسالة دعوتنا ورابط موقعنا مع شخصين (2) مختلفين آخرين على تطبيق الواتساب لدعوتهم للتسجيل والاستثمار." },
      ...
      { title: "📢 مشاركة رابط الدعوة على الواتساب (المجموعة الثالثة)", desc: "قم بمشاركة رسالة دعوتنا ورابط موقعنا مع شخصين (2) مختلفين آخرين على تطبيق الواتساب لدعوتهم للتسجيل والاستثمار." },
